...
public class AlarmAlertActivity extends Activity implements OnClickListener {
	...
	private za.co.neilson.alarm.alert.MathProblem mathProblem;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		case EASY:
			mathProblem = new za.co.neilson.alarm.alert.MathProblem(3);
			break;
		case MEDIUM:
			mathProblem = new za.co.neilson.alarm.alert.MathProblem(4);
			break;
		case HARD:
			mathProblem = new za.co.neilson.alarm.alert.MathProblem(5);
			break;
		}
	...
	protected void onPause() {
		super.onPause();
		za.co.neilson.alarm.alert.StaticWakeLock.lockOff(this);
	}
